...
@Test
  ...
  Scenario: Testing product search with categories
  ...
  Scenario: Testing search bar and filters
 ...
 Scenario:Testing the cart page
 ...
 Scenario: Testing log in to personal account and validating some data.
